...
typedef enum { OK, ERROR = 1 } errors;

static const s21_decimal half = {{0x5, 0x0, 0x0, 0x10000}};
static const s21_decimal one = {{0x1, 0x0, 0x0, 0x0}};

static const s21_decimal ten_powers[29] = {
    [0] = {{0x1, 0x0, 0x0, 0x0}},
    [1] = {{0xA, 0x0, 0x0, 0x0}},
    [2] = {{0x64, 0x0, 0x0, 0x0}},
    [3] = {{0x3E8, 0x0, 0x0, 0x0}},
...
void init_decimal_default(s21_decimal *d);
size_t get_first_non_zero(s21_decimal d);
int init_decimal_copy(s21_decimal *to, s21_decimal from);
bool get_bit(s21_decimal d, size_t n);
int get_sign(s21_decimal d);
int set_bit(s21_decimal *d, size_t n, int value);
size_t get_exp(s21_decimal d);
